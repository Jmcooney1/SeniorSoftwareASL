...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QHBoxLayout, QLineEdit, QApplication, QFrame, QMessageBox
)
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("ASL Motion Trainer Pro")
        ...
        # 2. State - FIXED PATH TO googleMedaPipe
        self.lib_path = os.path.join(root_dir, "googleMedaPipe", "asl_motion_library.npy")
        os.makedirs(os.path.dirname(self.lib_path), exist_ok=True) # Ensure folder exists
